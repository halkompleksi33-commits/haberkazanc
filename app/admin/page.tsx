...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetch("/api/admin/videos").then((r) => r.json()), fetch("/api/admin/contributors").then((r) => r.json())]).then(([videoData, contributorData]) => { setVideos(videoData.videos || []); setContributors(contributorData.contributors || []); }).catch(() => setMessage("Yönetim verileri yüklenemedi."));
  }, [authenticated]);
